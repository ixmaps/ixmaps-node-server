...
function nTrace(options, cb, finCB) {
  traceroute(options.address, options.timeout, options.interval, options.count || 4, options.maxTTL || 255, cb, finCB);
}
